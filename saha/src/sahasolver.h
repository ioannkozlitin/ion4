...
struct SahaPoint
{
   ...
   double T;		// температура ионная, а. е.
   double t;		// температура электронная, а. е.
   double V;		// объём атомной ячейки, а. е.
   double P;		// давление, а. е.
   double Pi;       // электронная компонента давления, а.е.
   double Pe;       // ионная компонента давления, а.е.
   double E;		// энергия, а. е.
   double Ei;       // ионная компонента энергии, а.е.
   double Ee;       // электронная компонента энергии, а.е.
   double S;		// энтропия, а. е.
   double Si;		// ионная компонента энтропии, а. е.
   double Se;		// электронная компонента энтропии, а. е.
